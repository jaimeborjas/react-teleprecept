...
function Review() {
  return (
    <div className="w-full mt-10 pl-60 pr-60">
      <Title className="text-3xl title review">What Our Users Say</Title>
      <div className="h-40 mt-10 pl-10 pr-10 flex items-center border-dashed border-4 border-blue-700">
        <Image src={userIcon} className="w-24" />
        <div className="ml-6">
          <Title className="text-xl text font-semibold mb-2">Satisfied User</Title>
          <Stars />
          <Text className="text-lg text mt-2">
